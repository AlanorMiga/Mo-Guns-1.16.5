...
public enum SpecialModels {
    ...
    LIGHT_SCARH_STOCK("light_scarh_stock"),
    TACTICAL_SCARH_STOCK("tactical_scarh_stock"),
    HEAVY_SCARH_STOCK("heavy_scarh_stock"),
    SCARH_MAIN("scarh_main"),
    SCARH_CHARGING_HANDLE("scarh_charging_handle"),
	G36C_MAIN("g36c_main"),
    ...
    M16A1_MAIN("m16a1_main"),
    M16A1_CHARGING_HANDLE("m16a1_charging_handle"),
    ...
    GLOCK_MAIN("glock_main"),
    GLOCK_HAPPY("glock_happy"),
    WRAPPED_RIFLE_MAIN("wrapped_rifle_main"),
    WRAPPED_RIFLE_CHAMBER("wrapped_rifle_chamber"),
    SNOWBALL_LAUNCHER_MAIN("snowball_launcher_main"),
    SNOWBALL_LAUNCHER_TANKS("snowball_launcher_tanks"),
